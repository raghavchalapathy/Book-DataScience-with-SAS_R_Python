...
\title{\Huge \textbf{Data Science with SAS, R and Python Learning Notes}  \footnote{This is my learning notes} }
% Author
%\author{\textsc{Raghav Chalapathy}\thanks{\url{www.example.com}}}
\author{\textsc{Raghav Chalapathy}}
...
Create an Autoexec step so that each time you open the project the data tables gets loaded on the library.
Step1: Load the SAS Data Files as a SAS library :
        LIBNAME <any_valid_sas_name>  <  path of the directory where .sas files are present>
        LIBNAME APOSTLE  $"C:\Files\Projects\Ambulance_NSW\rawdata"$;
